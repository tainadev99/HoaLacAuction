          ...
          this.setState(
            {
              fullName:
                ...
                middleName: res.data.data.Data.middleName,
              ...
              <ScrollView
                ...
                <View style={stylesUserDetail.row_container}>
                  <View style={stylesUserDetail.column_text}>
                    ...
                    <TextInput defaultValue={this.state.firstName} style={stylesUserDetail.txtIP} onChangeText={value => {
                      this.setState({firstName: value})
                    }} >
                    </TextInput>
                  </View>
                  <View style={stylesUserDetail.column_text1}>
                    <Text style={stylesUserDetail.text_general}>
                      Tên đệm:
                    </Text>
                    <TextInput style={stylesUserDetail.txtIP} defaultValue={this.state.middleName} onChangeText={value => {
                      this.setState({middleName: value})
                    }}>
                    </TextInput>
                  </View>
                  <View style={stylesUserDetail.column_text1}>
                    <Text style={stylesUserDetail.text_general}>Tên: </Text>
                    <TextInput style={stylesUserDetail.txtIP} onChangeText={value => {
