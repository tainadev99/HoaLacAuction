...
import {EDITPROFILE} from '../../navigation/routeNames';
        ...
        {this.state.isLoading ? (
          ...
          <View style={styleUserProfile.user_container}>
            <View style={styleUserProfile.topUser}>
              <View style={styleUserProfile.cover}>
                <Image style={styleUserProfile.cover} source={cover}></Image>
              ...
              <Text style={{fontWeight: 'bold', fontSize: 30, marginTop: 75}}>
                {this.state.fullName}
              </Text>
            </View>
