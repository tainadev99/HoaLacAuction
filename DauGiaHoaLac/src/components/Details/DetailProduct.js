    ...
    reg
      ...
      .then(res => {
        if (res.data.success) {
                ...
                () => {
                  if (
                    ...
                    if (
                      ...
                      Alert.alert(
                        'Kết quả đấu giá',
                        'Cuộc đấu giá này đã kết thúc, chúc mừng bạn đã là người chiến thắng. Chúng tôi sẽ liên hệ với bạn sớm nhất để hoàn tất thủ tục. Cảm ơn vì bạn đã tham gia hệ thống của chúng tôi!',
                      );
                    }
                  }
                },
          ...
          Alert.alert(
            'Cuộc đấu giá đã bị huỷ',
            'Cuộc đấu giá này đã bị huỷ vì một vài sự cố. Mong quý khách thông cảm, vẫn tin tưởng và sử dụng hệ thống của chúng tôi. Xin cảm ơn!',
            [
              {
                text: 'Quay lại',
                ...
                () => {
                  if (
                    ...
                    if (
                      ...
                      Alert.alert(
                        'Kết quả đấu giá',
                        'Cuộc đấu giá này đã kết thúc, rất tiếc bạn không phải là người chiến thắng. Cảm ơn bạn vì đã tham gia vào hệ thống của chúng!',
                      );
                    }
                  }
                },
          ...
          this.setState(
            ...
            () => {
              if (this.state.data.userStatus == 2) {
                ...
                Alert.alert(
                  'Thông báo',
                  'Trạng thái tài khoản: XÁC THỰC BỊ TỪ CHỐI \n' +
        ...
        {this.state.isLoading ? (
          ...
          <View style={{flex: 1}}>
            <ScrollView showsVerticalScrollIndicator={false}>
                      ...
                      if (this.state.isAuthen) {
                        if (this.state.data.userStatus == 2) {
                          if (
                            ...
                            Alert.alert(
                              'Bạn cần đăng ký tham gia đấu giá để xem lịch sử đấu giá',
                            );
                          }
                        } else if (this.state.data.userStatus == 1) {
                          Alert.alert(
                        ...
                        Alert.alert(
                          'THÔNG BÁO',
                          'Bạn cần đăng nhập để xem lịch sử đấu giá',
                          [
                            {
              ...
              <Details title="Mã tài sản:" code={'MTS-' + this.state.data.id} />
              <Details
